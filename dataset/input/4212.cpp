...
int main() {
    ...
    // Semantic error: Loop condition causes out-of-bounds access.
    // 'i <= 3' means it will try to access matrix1[3][j] and matrix2[3][j],
    // which is outside the declared 3x3 array bounds (indices 0, 1, 2).
