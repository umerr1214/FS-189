...
public:
    ...
    // Readability / Efficiency Issue: Correct, but less idiomatic/efficient than copy-and-swap.
    // Manual resource management is more verbose and potentially less efficient due to multiple
    // explicit allocations/deallocations, and it's harder to ensure strong exception safety.
    StringWrapper& operator=(const StringWrapper& other) {
        if (this == &other) { // Self-assignment check
            return *this;
        }

        // Allocate new memory first to ensure strong exception safety.
        // If new char[] throws, the original *this is untouched.
