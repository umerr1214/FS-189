...
// Function to check if a string is a palindrome, ignoring case but NOT non-alphanumeric characters
bool isPalindrome(const std::string& str) {
    std::string cleaned_str;
    for (char c : str) {
        // Logical Error: Only converts to lowercase, but does not filter out non-alphanumeric characters.
        // Spaces, commas, etc., will be included in cleaned_str, making the check incorrect.
