...
int main() {
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        std::cout << "Name: ";
        // SEMANTIC ERROR: Using '>>' operator for std::string, which reads only
        // up to the first whitespace. If a product name contains spaces (e.g., "Gaming Mouse"),
        // only the first word ("Gaming") will be read, truncating the name.
