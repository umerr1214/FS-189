...
public:
    ...
    void displayDetails() const {
        // LOGICAL ERROR: Forgetting to call the base class displayDetails method
        // Employee::displayDetails(); // This line is commented out, causing the error
...
int main() {
    ...
    mgr.displayDetails(); // This will only show department, not name/ID
