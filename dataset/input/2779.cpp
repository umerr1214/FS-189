#include <iostream>
#include <limits> // Required for checking INT_MAX

class Calculator {
public:
    // Adds two integers
    int add(int a, int b) {
        // In a robust implementation, one might check for overflow:
        // if ((b > 0) && (a > std::numeric_limits<int>::max() - b)) {
        //     // Handle overflow, e.g., throw an exception or return a special value
        //     // For this example, we just perform the addition which might overflow
        // }
    ...
    int add(int a, int b, int c) {
        // Similar overflow considerations apply here.
        // For simplicity and to demonstrate the robustness issue,
        // we perform direct addition without explicit checks.
        return a + b + c;
    }
...
int main() {
    ...
    std::cout << "add(2000000000,1000000000):" << calc.add(2000000000, 1000000000) << ";"; // Potential overflow
    ...
    std::cout << "add(1000000000,1000000000,1000000000):" << calc.add(1000000000, 1000000000, 1000000000) << ";"; // Potential overflow
