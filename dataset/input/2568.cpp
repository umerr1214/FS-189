...
public:
    ...
    // Overload unary minus operator (SEMANTIC ERROR: returns a reference to a local temporary object)
    ComplexNumber& operator-() const { // Incorrect return type: should be ComplexNumber, not ComplexNumber&
        ComplexNumber temp(-real, -imag);
        return temp; // Returns a reference to a local variable 'temp' which will be destroyed
    }
...
int main() {
    ...
    ComplexNumber res1 = -c1; // May lead to undefined behavior
    ...
    ComplexNumber res2 = -c2; // May lead to undefined behavior
    ...
    ComplexNumber res3 = -c3; // May lead to undefined behavior
    ...
    ComplexNumber res4 = -c4; // May lead to undefined behavior
    ...
    ComplexNumber res5 = -c5; // May lead to undefined behavior
