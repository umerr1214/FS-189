...
public:
    ...
    void setYear(int newYear) {
        // Logical Error: Ignores newYear and sets a fixed incorrect value
        year = 1900;
    }
...
int main() {
    ...
    myVehicle.setYear(2022); // Tries to set to 2022, but the setter has a logical error
    std::cout << "Modified year via setter: " << myVehicle.getYear() << std::endl; // Will output 1900
    std::cout << "----------------------" << std::endl;
