#include <iostream>
#include <vector>
#include <cmath> // Not strictly needed for squared distance
...
int main() {
    ...
    for (size_t i = 1; i < points.size(); ++i) {
        ...
        // Logical Error: The comparison operator is inverted, finding the furthest point instead of the closest.
        if (current_dist_sq > min_dist_sq) { // Should be '<'
