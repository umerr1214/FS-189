...
int main() {
    ...
    const int PI = 3.14159; // Semantic error: PI is an int, will be truncated to 3
    ...
    while (true) {
        ...
        switch (choice) {
            case 1:
                ...
                std::cout << "Area of circle: " << std::fixed << std::setprecision(7) << PI * radius * radius << std::endl; // Will use PI=3 due to truncation
                break;
            case 2:
            ...
            case 3:
                ...
                std::cout << "Area of triangle: " << std::fixed << std::setprecision(7) << 0.5 * base * height << std::endl;
                break;
            case 4:
