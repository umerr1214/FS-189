...
public:
    ...
    void displayAllDetails() const {
        // LOGICAL ERROR: Forgets to call Person::displayDetails() to show inherited details.
        // It only displays Employee-specific details, violating the "including inherited ones" requirement.
