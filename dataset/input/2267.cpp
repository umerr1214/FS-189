...
public:
    ...
    void castSpell() {
        ...
        modifyHealth(10); // Intended to increase health by 10
    }

    // Member function to modify health - LOGICAL ERROR HERE
    // Instead of adding 'amount', it sets health to 'amount'
    void modifyHealth(int amount) {
        health = amount; // Logical Error: This sets health to 'amount', not adds 'amount' to current health.
...
int main() {
    ...
    gandalf.displayWizardInfo(); // Initial health: 100
    gandalf.castSpell();        // Calls modifyHealth(10), which sets health to 10
    gandalf.displayWizardInfo(); // Health after modification: 10
