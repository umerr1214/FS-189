...
public:
    // LOGICAL ERROR: Manager constructor passes hardcoded 0 for employeeId and salary to Employee constructor
    Manager(const std::string& name, int employeeId, double salary, const std::string& department)
        : Employee(name, 0, 0.0), department(department) { // employeeId and salary from parameters are ignored
